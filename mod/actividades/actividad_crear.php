...
<form id="editor" method="POST" action="page.php?op=15">
    <h1><center>ACTIVIDADES</center></h1>
    <b>Codigo  Actividad </b> <div class="item"> <input class="input" type="text" name="act_id" value=""> <br> </div>
    <b>Nombre  Actividad </b> <div class="item"> <input class="input" type="text" name="act_titulo" value=""><br></div>
<br><b> Contenido </b> <div class="item">
