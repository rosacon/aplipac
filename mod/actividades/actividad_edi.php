   ...
   <form action="page.php?op=18" method="post">
     <fieldset>
       ...
       <div class="edi1">
         ...
         <input type="text" class="edi" name="act_id" value="<?php echo $row['act_id']; ?>" /> <br />
       </div>
       ...
       <div class="edi1">
         ...
         <input type="text" class="edi" name="act_titulo" value="<?php echo $row['act_titulo']; ?>" /><br />
       </div>
       <div class="edi1">
       ...
       <div class="edi1">
         ...
         <input type="text" class="edi" name="act_nivel" value="<?php echo $row['act_nivel']; ?>" /><br />
       </div>

       <div class="edi1">
         <label>parte_actua
         </label>
         <input type="text" class="edi" name="act_parte_actua" value="<?php echo $row['act_parte_actua']; ?>" /><br />
       </div>
