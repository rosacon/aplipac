 ...
 <tr>
 <td colspan="4">
¬||¬ CUESTIONARIO MUSCULO ESQUELETICO ¬||¬</td></tr>
 </thead>
            <tbody>
  <tr>
...
<tr>
 ...
 <?php echo $cadena['p68']; ?>  </td><td> <input size=1px type="text" name="pie"                id="pie"> </td><td> 
 <?php echo $cadena['p72']; ?>  </td><td> <input size=1px type="text" name="medio"              id="medio"></td><td> 
 <?php echo $cadena['p69']; ?>  </td><td> <input size=1px type="text" name="cucli"              id="cucli"></td><td> 
 <?php echo $cadena['p73']; ?>  </td><td> <input size=1px type="text" name="flexionandot"       id="flexionandot"></td></tr><td> 
 <?php echo $cadena['p70']; ?>  </td><td> <input size=1px type="text" name="girandot"           id="girandot"></td><td> 
 <?php echo $cadena['p74']; ?>  </td><td> <input size=1px type="text" name="inclinandoadelante" id="inclinandoadelante"></td><td>
 <?php echo $cadena['p71']; ?>  </td><td> <input size=1px type="text" name="sentado"            id="sentado"></td><td> 
 <?php echo $cadena['p75']; ?>  </td><td> <input size=1px type="text" name="caminando"          id="caminando"></td></tr>
 </table>


 <table border="1px">
 <tr><td colspan="4"><b><?php echo $cadena['p76']; ?> </b></td></tr>

 <tr><td colspan="4">   <?php echo $cadena['p77']; ?>     </td></tr>
 <br>
 
<tr><td>                <?php echo $cadena['p78']; ?>
 </td>
 
 <td>
 si        <input type=radio name="rta40" value="si">
 no        <input type=radio name="rta40" value="no">             </td></tr>
 
 <tr><td>              <?php echo $cadena['p79']; ?>      </td>
 
 <td>si    <input type=radio name="rta41" value="si" id="rta41">
 no        <input type=radio name="rta41" value="no" id="rta41"> </td>
 <tr><td>             <?php echo $cadena['p80']; ?></td><td>
 si        <input type=radio name="rta42" value="si" id="rta42">
 no        <input type=radio name="rta42" value="no" id="rta42">
  </td>
 <tr><td>             <?php echo $cadena['p81']; ?>
